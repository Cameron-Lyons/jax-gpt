...
for k in range(num_samples):
    ...
    for _ in range(max_new_tokens):
        ...
        idx_cond = generated if generated.shape[1] <= model_config.block_size else generated[:, -model_config.block_size:]

        # Forward pass
        logits, _ = model.apply(variables, idx_cond, training=False)
